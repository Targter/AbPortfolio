  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="p-5  lg:rounded-2xl rounded-xl lg:w-[280px] w-[70%] bg-[rgb(21 16 48)] bg-[rgb(45,55,69)] lg:ml-0 ml-8 lg:flex-none flex flex-col lg:items-start items-center overflow-hidden"
      >
...
const Box5Container = () => {
  return (
    <>
      <motion.div
        className="w-full h-auto bg-black relative lg:pl-11 pl-2 mt-[20px]"
      ...
      >
        <motion.div className="lg:w-4/5 w-full h-auto flex flex-col items-center ml-1 lg:ml-11 md:ml-24 mt-11">
          ...
          <div className="w-full flex overflow-hidden justify-center">
            <motion.p
              ...
              className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px] text-white overflow-hidden lg:pl-0 pl-2 text-center 
          lg:pr-0 pr-2 "
            >
        ...
        <div className="h-auto mt-[70px] flex flex-wrap lg:gap-11 gap-5 justify-center">
